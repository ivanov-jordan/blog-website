...
public class PasswordUtils {
     ...
     * The bcrypt workload is specified in the above static variable, a value
     * from 10 to 31.
     * A workload of 12 is a very reasonable safe default as of 2013.
     * This automatically handles secure 128-bit salt generation and storage
     * within the hash.
     * 
     ...
     * during a login
     * request) with that of a stored hash from a database. The password hash
     * from the database
